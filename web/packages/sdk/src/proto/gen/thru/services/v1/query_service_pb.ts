...
import type { Account, AccountSchema, AccountView, DataSlice, RawAccount, RawAccountSchema } from "../../core/v1/account_pb";
...
export type GetRawAccountRequest = Message<"thru.services.v1.GetRawAccountRequest"> & {
  ...
  /**
   * Controls which sections of the raw response are returned.
   * ACCOUNT_VIEW_UNSPECIFIED and ACCOUNT_VIEW_FULL (default) return both
   * raw_meta and raw_data. ACCOUNT_VIEW_META_ONLY skips the data fetch
   * entirely and omits raw_data from the response. ACCOUNT_VIEW_DATA_ONLY
   * and ACCOUNT_VIEW_PUBKEY_ONLY are rejected with InvalidArgument: raw_meta
   * is a REQUIRED field on RawAccount, so a raw response without it has no
   * honest encoding, and a raw response of only an address is meaningless.
   *
   * @generated from field: optional thru.core.v1.AccountView view = 2;
   */
  view?: AccountView | undefined;
 ...
 */
export type GetChainInfoRequest = Message<"thru.services.v1.GetChainInfoRequest"> & {
};
 ...
 */
export type GetChainInfoResponse = Message<"thru.services.v1.GetChainInfoResponse"> & {
  /**
...
export const StateRootEntrySchema: GenMessage<StateRootEntry> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 29);
...
export const GetStateRootsResponseSchema: GenMessage<GetStateRootsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 30);
 ...
 */
export const GetActiveStateHashesRequestSchema: GenMessage<GetActiveStateHashesRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 31);
 ...
 */
export type ActiveStateHashEntry = Message<"thru.services.v1.ActiveStateHashEntry"> & {
  /**
   * @generated from field: uint64 slot = 1;
   */
  slot: bigint;
 ...
 */
export const ActiveStateHashEntrySchema: GenMessage<ActiveStateHashEntry> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 32);
 ...
 */
export type GetActiveStateHashesResponse = Message<"thru.services.v1.GetActiveStateHashesResponse"> & {
  /**
 ...
 */
export const GetActiveStateHashesResponseSchema: GenMessage<GetActiveStateHashesResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 33);
 ...
 */
export type GetSlotMetricsRequest = Message<"thru.services.v1.GetSlotMetricsRequest"> & {
  /**
 ...
 */
export const GetSlotMetricsRequestSchema: GenMessage<GetSlotMetricsRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 34);
 ...
 */
export type GetSlotMetricsResponse = Message<"thru.services.v1.GetSlotMetricsResponse"> & {
  /**
   * Block slot number.
   *
   * @generated from field: uint64 slot = 1;
   ...
   * because the block producer account was not live (UNTO-1293). Field
   * number unchanged (4).
   *
   * @generated from field: uint64 absent_block_producer_fees = 4;
   */
  ...
  /**
   * Fees credited to a live block-producer account this block. Disjoint from
   * absent_block_producer_fees by destination; total block fees =
   * absent_block_producer_fees + claimed_fees.
   *
   * @generated from field: uint64 claimed_fees = 6;
   */
  claimedFees: bigint;
};
 ...
 */
export const GetSlotMetricsResponseSchema: GenMessage<GetSlotMetricsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 35);
 ...
 */
export type ListSlotMetricsRequest = Message<"thru.services.v1.ListSlotMetricsRequest"> & {
  /**
 ...
 */
export const ListSlotMetricsRequestSchema: GenMessage<ListSlotMetricsRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 36);
 ...
 */
export type ListSlotMetricsResponse = Message<"thru.services.v1.ListSlotMetricsResponse"> & {
  /**
 ...
 */
export const ListSlotMetricsResponseSchema: GenMessage<ListSlotMetricsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 37);
 ...
 */
export type GetNodePubkeyRequest = Message<"thru.services.v1.GetNodePubkeyRequest"> & {
};
 ...
 */
export const GetNodePubkeyRequestSchema: GenMessage<GetNodePubkeyRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 38);
 ...
 */
export type GetNodePubkeyResponse = Message<"thru.services.v1.GetNodePubkeyResponse"> & {
  /**
 ...
 */
export const GetNodePubkeyResponseSchema: GenMessage<GetNodePubkeyResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 39);
 ...
 */
export type GetNodeRecordsRequest = Message<"thru.services.v1.GetNodeRecordsRequest"> & {
};
 ...
 */
export const GetNodeRecordsRequestSchema: GenMessage<GetNodeRecordsRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 40);
 ...
 */
export type GetNodeRecordsResponse = Message<"thru.services.v1.GetNodeRecordsResponse"> & {
  /**
 ...
 */
export const GetNodeRecordsResponseSchema: GenMessage<GetNodeRecordsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 41);
 ...
 */
export type GetNodeStatusRequest = Message<"thru.services.v1.GetNodeStatusRequest"> & {
};
...
export const GetNodeStatusRequestSchema: GenMessage<GetNodeStatusRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 42);
 ...
 */
export type GetNodeStatusResponse = Message<"thru.services.v1.GetNodeStatusResponse"> & {
  /**
...
export const GetNodeStatusResponseSchema: GenMessage<GetNodeStatusResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 43);
 ...
 */
export type NodeConsensusStatus = Message<"thru.services.v1.NodeConsensusStatus"> & {
  /**
 ...
 */
export const NodeConsensusStatusSchema: GenMessage<NodeConsensusStatus> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 44);
 ...
 */
export type NodeRepairStatus = Message<"thru.services.v1.NodeRepairStatus"> & {
  /**
 ...
 */
export const NodeRepairStatusSchema: GenMessage<NodeRepairStatus> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 45);

/**
 * BatchGetRawAccountsRequest fetches raw bytes for many accounts in one call.
 *
 * Batching exists because the per-account path costs up to three ClickHouse
 * round-trips (current meta, historical meta, historical pages), so N accounts
 * fetched one at a time is 3N sequential queries. The batch answers the whole
 * set in a fixed number of queries regardless of N.
 *
 * @generated from message thru.services.v1.BatchGetRawAccountsRequest
 */
export type BatchGetRawAccountsRequest = Message<"thru.services.v1.BatchGetRawAccountsRequest"> & {
  /**
   * The accounts to fetch. At most 1000 (BATCH_GET_MAX_ITEMS); a larger batch
   * is rejected with INVALID_ARGUMENT rather than silently truncated, because
   * the address list is rendered into the SQL and would otherwise run into
   * ClickHouse's max_query_size.
   *
   * @generated from field: repeated thru.services.v1.BatchGetRawAccountsItem items = 1;
   */
  items: BatchGetRawAccountsItem[];

  /**
   * Version applied to every item that does not carry its own. Set this alone
   * to read the whole batch at one version -- the common case -- instead of
   * repeating the same context on each item.
   *
   * @generated from field: optional thru.common.v1.VersionContext version_context = 2;
   */
  versionContext?: VersionContext | undefined;
  ...
  /**
   * @generated from field: optional thru.core.v1.AccountView view = 4;
   */
  view?: AccountView | undefined;
};

/**
 * Describes the message thru.services.v1.BatchGetRawAccountsRequest.
 * Use `create(BatchGetRawAccountsRequestSchema)` to create a new message.
 */
export const BatchGetRawAccountsRequestSchema: GenMessage<BatchGetRawAccountsRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 46);

/**
 * BatchGetRawAccountsItem is one account in a batch, optionally pinned to its
 * own version.
 *
 * @generated from message thru.services.v1.BatchGetRawAccountsItem
 */
export type BatchGetRawAccountsItem = Message<"thru.services.v1.BatchGetRawAccountsItem"> & {
  /**
   * @generated from field: thru.common.v1.Pubkey address = 1;
   */
  address?: Pubkey | undefined;
  ...
  /**
   * Overrides the request-level version_context for this account only. Leave
   * unset to inherit it. Set it when the batch reads accounts at DIFFERENT
   * versions -- e.g. verifying each account at the slot its own transaction
   * executed in.
   *
   * @generated from field: optional thru.common.v1.VersionContext version_context = 2;
   */
...
/**
 * Describes the message thru.services.v1.BatchGetRawAccountsItem.
 * Use `create(BatchGetRawAccountsItemSchema)` to create a new message.
 */
export const BatchGetRawAccountsItemSchema: GenMessage<BatchGetRawAccountsItem> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 47);

/**
 * BatchGetRawAccountsResponse returns the accounts that were found.
 *
 * PARTIAL BY DESIGN: an address that does not exist is simply ABSENT from the
 * map rather than failing the call, so one missing account cannot destroy a
 * batch of 1000. Callers must look up their addresses rather than assume the
 * map is complete.
 *
 * @generated from message thru.services.v1.BatchGetRawAccountsResponse
 */
export type BatchGetRawAccountsResponse = Message<"thru.services.v1.BatchGetRawAccountsResponse"> & {
  /**
   * Keyed by the encoded account address, as returned elsewhere in this API.
   *
   * @generated from field: map<string, thru.core.v1.RawAccount> accounts = 1;
   */
  accounts: { [key: string]: RawAccount };
};

/**
 * Describes the message thru.services.v1.BatchGetRawAccountsResponse.
 * Use `create(BatchGetRawAccountsResponseSchema)` to create a new message.
 */
export const BatchGetRawAccountsResponseSchema: GenMessage<BatchGetRawAccountsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 48);

/**
 * BatchGetTransactionsRequest fetches many decoded transactions in one call.
 *
 * @generated from message thru.services.v1.BatchGetTransactionsRequest
 */
export type BatchGetTransactionsRequest = Message<"thru.services.v1.BatchGetTransactionsRequest"> & {
  /**
   * At most 1000 (BATCH_GET_MAX_ITEMS); see BatchGetRawAccountsRequest.items.
   *
  ...
  /**
   * @generated from field: optional thru.core.v1.TransactionView view = 4;
   */
  view?: TransactionView | undefined;
};

/**
 * Describes the message thru.services.v1.BatchGetTransactionsRequest.
...
export const BatchGetTransactionsRequestSchema: GenMessage<BatchGetTransactionsRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 49);

/**
 * BatchGetTransactionsResponse returns the transactions that were found.
 *
 * PARTIAL BY DESIGN, exactly as BatchGetRawAccountsResponse: an unknown
 * signature is absent from the map, not an error.
 *
 * @generated from message thru.services.v1.BatchGetTransactionsResponse
 */
export type BatchGetTransactionsResponse = Message<"thru.services.v1.BatchGetTransactionsResponse"> & {
  /**
   * Keyed by the encoded transaction signature.
   *
   * @generated from field: map<string, thru.core.v1.Transaction> transactions = 1;
   */
  transactions: { [key: string]: Transaction };
};

/**
 * Describes the message thru.services.v1.BatchGetTransactionsResponse.
...
export const BatchGetTransactionsResponseSchema: GenMessage<BatchGetTransactionsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 50);

/**
 * BatchGenerateStateProofsRequest generates many state proofs in one call.
 *
 * A single proof descends the state trie root-to-leaf, one node fetch per
 * level, and that descent cannot be parallelised -- each node is what reveals
 * the next hash.  What CAN be shared is the descent across proofs: every
 * request in the batch needs its depth-d node at the same moment, so N proofs
 * over a depth-D trie cost D round-trips rather than N*D.
 *
 * @generated from message thru.services.v1.BatchGenerateStateProofsRequest
 */
export type BatchGenerateStateProofsRequest = Message<"thru.services.v1.BatchGenerateStateProofsRequest"> & {
  /**
   * At most 1000; a larger batch is rejected rather than truncated.
   *
   * Every request's own target_slot must be UNSET: the slot is chosen once for
   * the batch, below. A request that sets it is rejected rather than ignored.
   *
   * @generated from field: repeated thru.core.v1.StateProofRequest requests = 1;
   */
  requests: StateProofRequest[];

  /**
   * The slot whose state root every proof in this batch is built against.
   * Unset (or 0) selects the latest usable root, as the per-request RPC does.
   *
   * BATCH-LEVEL, NOT PER-REQUEST, deliberately. A proof is only usable by a
   * block whose execution slot falls inside the runtime's ACCEPTS window, so
   * every proof a caller assembles for one block already shares one slot;
   * mixing slots in a batch has no use and is expensive to serve. Each distinct
   * slot costs its own root resolution and its own full trie descent, so a
   * 1000-request batch of distinct slots performs ~1000 descents instead of one
   * shared walk -- the same work as 1000 separate calls, bought with a single
   * round-trip. Hoisting the slot here makes that shape unrepresentable rather
   * than merely rejected.
   *
   * @generated from field: optional uint64 target_slot = 2;
   */
  targetSlot?: bigint | undefined;
};

/**
 * Describes the message thru.services.v1.BatchGenerateStateProofsRequest.
 * Use `create(BatchGenerateStateProofsRequestSchema)` to create a new message.
 */
export const BatchGenerateStateProofsRequestSchema: GenMessage<BatchGenerateStateProofsRequest> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 51);

/**
 * BatchGenerateStateProofsResponse returns one result per request, IN THE ORDER
 * REQUESTED.
 *
 * Results are positional rather than keyed because the same account may
 * legitimately appear more than once in a batch (at different proof types), so
 * an address alone does not identify a request.
 *
 * @generated from message thru.services.v1.BatchGenerateStateProofsResponse
 */
export type BatchGenerateStateProofsResponse = Message<"thru.services.v1.BatchGenerateStateProofsResponse"> & {
  /**
   * @generated from field: repeated thru.services.v1.StateProofResult results = 1;
   */
  results: StateProofResult[];
};

/**
 * Describes the message thru.services.v1.BatchGenerateStateProofsResponse.
 * Use `create(BatchGenerateStateProofsResponseSchema)` to create a new message.
 */
export const BatchGenerateStateProofsResponseSchema: GenMessage<BatchGenerateStateProofsResponse> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 52);

/**
 * StateProofResult is one request's outcome.
 *
 * PARTIAL BY DESIGN: a key that cannot be proved -- absent when membership was
 * asked, present when non-membership was -- is an ordinary answer ABOUT THAT
 * KEY and must not fail the other 999.  Exactly one of proof/error is set.
 *
 * @generated from message thru.services.v1.StateProofResult
 */
export type StateProofResult = Message<"thru.services.v1.StateProofResult"> & {
  /**
   * @generated from field: optional thru.core.v1.StateProof proof = 1;
   */
  proof?: StateProof | undefined;

  /**
   * google.rpc.Code for this request, 0 when proof is set.
   *
...
/**
 * Describes the message thru.services.v1.StateProofResult.
 * Use `create(StateProofResultSchema)` to create a new message.
 */
export const StateProofResultSchema: GenMessage<StateProofResult> = /*@__PURE__*/
  messageDesc(file_thru_services_v1_query_service, 53);
 ...
 */
export const NodeModeSchema: GenEnum<NodeMode> = /*@__PURE__*/
  enumDesc(file_thru_services_v1_query_service, 0);
...
export const QueryService: GenService<{
  ...
  /**
   * Get raw bytes for many accounts in one call. Partial: addresses that do
   * not exist are absent from the response map.
   *
   * @generated from rpc thru.services.v1.QueryService.BatchGetRawAccounts
   */
  batchGetRawAccounts: {
    methodKind: "unary";
    input: typeof BatchGetRawAccountsRequestSchema;
    output: typeof BatchGetRawAccountsResponseSchema;
  },
  /**
   * Get many transactions in one call. Partial: unknown signatures are absent
   * from the response map.
   *
   * @generated from rpc thru.services.v1.QueryService.BatchGetTransactions
   */
   ...
   * Generate many state proofs in one call, sharing the trie descent across
   * them. Partial: a request that cannot be proved carries its own error.
   *
   * @generated from rpc thru.services.v1.QueryService.BatchGenerateStateProofs
   */
  batchGenerateStateProofs: {
    methodKind: "unary";
    input: typeof BatchGenerateStateProofsRequestSchema;
    output: typeof BatchGenerateStateProofsResponseSchema;
  },
  /**
  ...
  /**
   * Get slot-level metrics including state counters and distributed fees
   * (absent-block-producer + claimed).
   *
