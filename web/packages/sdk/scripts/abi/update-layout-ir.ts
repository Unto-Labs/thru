...
import { SUPPORTED_IR_VERSION } from "../../src/abi/ir/schema";
...
function parseArgs(argv: string[]): CliOptions {
  ...
  let outPath = "src/abi/ir/generated/layout.ir.json";
...
Update 'SUPPORTED_IR_VERSION' in src/abi/ir/schema.ts before refreshing layouts.`,
    );
  }
