...
const hasWasmArtifacts = existsSync(
  new URL("../../../wasm/abi/node/abi_reflect_wasm.js", import.meta.url),
);

const describeWasm = hasWasmArtifacts ? describe : describe.skip;

describeWasm("WASM bridge exports", () => {
  beforeAll(async () => {
