...
import { PubkeySchema } from "@thru/sdk/proto";
import { TransactionSchema } from "@thru/sdk/proto";
import { TXN_HEADER_BODY_SIZE, SIGNATURE_SIZE } from "../../../wire-format";
...
describe("Transaction.fromProto", () => {
    ...
    it("parses a proto containing only dynamic sections", () => {
        const transaction = buildTestTransaction();
        const wire = transaction.toWire();
        const bodyWithoutHeader = wire.slice(TXN_HEADER_BODY_SIZE, -SIGNATURE_SIZE);
