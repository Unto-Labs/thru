...
All language backends consume the shared layout IR defined in `rpc/abi/abi_gen/src/codegen/shared/ir.rs`. This document explains the schema, the builder algorithm, and how to extend either piece safely.
...
Located in `rpc/abi/abi_gen/src/codegen/shared/builder.rs`.
