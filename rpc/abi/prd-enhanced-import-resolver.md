...
imports:
  - type: onchain
    address: "Abc123..."  # ta-prefixed Thru address
...
| **TNS Detection** | Deferred; ABI imports currently require ta-prefixed addresses |
...
3. Validate remaining imports use the same network and fail if any do not
...
| File | Purpose |
|------|---------|
| `rpc/abi/abi_loader/src/fetcher/mod.rs` | Fetcher trait + CompositeFetcher |
| `rpc/abi/abi_loader/src/fetcher/path.rs` | Local file fetcher |
| `rpc/abi/abi_loader/src/fetcher/git.rs` | Git repository fetcher |
| `rpc/abi/abi_loader/src/fetcher/http.rs` | HTTP URL fetcher |
| `rpc/abi/abi_loader/src/fetcher/onchain.rs` | On-chain ABI fetcher |
| `rpc/abi/abi_loader/src/fetcher/cache.rs` | Optional caching layer |
| `rpc/abi/abi_loader/src/fetcher_config.rs` | Fetcher configuration types |
| `rpc/abi/abi_loader/src/package.rs` | PackageId, ResolvedPackage types |
...
| File | Changes |
|------|---------|
| `rpc/abi/abi_loader/src/file.rs` | Add Import, ImportSource, RevisionSpec enums |
| `rpc/abi/abi_loader/src/resolver.rs` | Replace with async EnhancedImportResolver |
| `rpc/abi/abi_loader/src/flatten.rs` | Use new resolver |
| `rpc/abi/abi_loader/src/lib.rs` | Export new modules |
| `rpc/abi/abi_loader/Cargo.toml` | Add async-trait, tokio, reqwest, git2, sha2 |
| `rpc/abi/abi_reflect_wasm/src/lib.rs` | Add manifest-based reflection functions |
| `rpc/abi/abi_cli/src/main.rs` | Add prep-for-publish, bundle commands + fetcher flags |
