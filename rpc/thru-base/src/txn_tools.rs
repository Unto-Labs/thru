...
fn add_authority_account(mut tx: Transaction, authority: TnPubkey, fee_payer: TnPubkey, next_idx: u16) -> (Transaction, u16) {
...
impl TransactionBuilder {
    ...
    pub fn build_token_transfer(
        ...
        let instruction_data = build_token_transfer_instruction(
            source_account_idx,
            dest_account_idx,
            amount,
        )?;
