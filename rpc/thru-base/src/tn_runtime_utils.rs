...
pub const TN_RUNTIME_TXN_ERR_FEE_PAYER_ACTIVATION_REQUIRES_STATE_UNIT: i32 =
    0x0F | TN_RUNTIME_ERR_CLASS__TXN_IN_PRE_EXECUTE;
pub const TN_RUNTIME_TXN_ERR_BLOCK_STATE_BUDGET_EXCEEDED: i32 =
    0x10 | TN_RUNTIME_ERR_CLASS__TXN_IN_PRE_EXECUTE;
...
pub fn tn_vm_error_str(err: i32) -> Option<&'static str> {
    match err {
        ...
        TN_RUNTIME_TXN_ERR_FEE_PAYER_ACTIVATION_REQUIRES_STATE_UNIT => {
            Some("TN_RUNTIME_TXN_ERR_FEE_PAYER_ACTIVATION_REQUIRES_STATE_UNIT")
        }
        TN_RUNTIME_TXN_ERR_BLOCK_STATE_BUDGET_EXCEEDED => {
            Some("TN_RUNTIME_TXN_ERR_BLOCK_STATE_BUDGET_EXCEEDED")
        }
