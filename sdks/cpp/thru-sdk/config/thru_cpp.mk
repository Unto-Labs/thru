...
$(OBJDIR)/bin/$(1).elf: $(foreach obj,$(2),$(OBJDIR)/obj/$(MKPATH)$(obj).o) $(foreach lib,$(3),$(OBJDIR)/lib/lib$(lib).a)
	...
	#######################################################################
	$(MKDIR) $$(dir $$@) && \
$(CXX) $(CXXFLAGS) -o $$@ $(foreach obj,$(2),$(OBJDIR)/obj/$(MKPATH)$(obj).o) -L$(OBJDIR)/lib $(4) $(foreach lib,$(3), -l$(lib)) $(LDFLAGS)
...
$(1): $(OBJDIR)/bin/$(1).bin $(OBJDIR)/bin/$(1).s
...
$(OBJDIR)/unit-test/test_$(1): $(OBJDIR)/obj/test_$(1).o $(OBJDIR)/lib/libtn_sdk.a
	...
	#######################################################################
	$(MKDIR) $$(dir $$@) && \
$(CXX) $(CXXFLAGS) $(LDFLAGS) -o $$@ $$< -L$(OBJDIR)/lib -ltn_sdk
...
# Include all the dependencies.  Must be after the make fragments include
