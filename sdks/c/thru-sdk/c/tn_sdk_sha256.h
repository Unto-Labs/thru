...
/* TODO: this should use the Firedancer sha256 implementation or at least the
   same interface. I would like to avoid having to copy the sha256 implementation into the ThruVM SDK. */

/* This sha256 implementation is from the Firedancer project. */

#define TSDK_SHA256_LG_BLOCK_SZ (6)
#define TSDK_SHA256_BLOCK_SZ    (64UL) /* == 2^FD_SHA256_LG_BLOCK_SZ, explicit to workaround compiler limitations */
...
void * tsdk_sha256_hash( void const * _data,
                         ulong        sz,
                         void *       _hash );
