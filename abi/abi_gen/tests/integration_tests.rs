...
fn test_complete_abi_analysis_pipeline() {
  ...
  let typedefs = vec![
    // Simple base type
    TypeDef { name: "BaseType".to_string(), kind: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        ...
        fields: vec![
          StructField { name: "header".to_string(), field_type: TypeKind::TypeRef(TypeRefType { name: "BaseType".to_string(), comment: None }) },
          StructField {
            name: "data".to_string(),
    ...
    TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        container_attributes: Default::default(),
        tag_ref: ExprKind::Sizeof(SizeofExpr { type_name: "BaseType".to_string() }),
        variants: vec![EnumVariant {
          name: "Variant1".to_string(),
          tag_value: 1,
          variant_type: TypeKind::TypeRef(TypeRefType { name: "ValidStruct".to_string(), comment: None }),
        }],
      }),
    },
  ];
  ...
  assert!(analysis.layout_violations.is_empty(), "Should not have layout violations");
  assert!(analysis.topological_order.is_some(), "Should have topological order");
  ...
  assert!(base_pos < struct_pos, "BaseType should come before ValidStruct");
  assert!(struct_pos < enum_pos, "ValidStruct should come before ValidEnum");
...
fn test_invalid_enum_tag_layout_cycle_detection() {
  let typedefs = vec![
      ...
      kind: TypeKind::Struct(StructType {
        ...
        fields: vec![
          StructField {
            ...
            field_type: TypeKind::TypeRef(TypeRefType { name: "ProblematicEnum".to_string(), comment: None }),
          },
          StructField { name: "referenced_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        ...
        tag_ref: ExprKind::FieldRef(FieldRefExpr { path: vec!["Container".to_string(), "referenced_field".to_string()] }),
        variants: vec![EnumVariant {
          name: "Variant1".to_string(),
          tag_value: 1,
  ...
  assert!(!analysis.layout_violations.is_empty(), "Should detect layout violations");

  let violation =
    analysis.layout_violations.iter().find(|v| v.violating_type == "ProblematicEnum").expect("Should find violation for ProblematicEnum");

  assert!(
    violation.reason.contains("forward reference") || violation.reason.contains("layout cycle") || violation.reason.contains("circular dependency")
  );
...
fn test_forward_field_reference_detection() {
      ...
      kind: TypeKind::Struct(StructType {
        ...
        fields: vec![
          StructField {
            ...
            field_type: TypeKind::TypeRef(TypeRefType { name: "ForwardRefArray".to_string(), comment: None }),
          },
          StructField { name: "middle_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
          StructField { name: "late_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    },
    TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        ...
        size: ExprKind::FieldRef(FieldRefExpr { path: vec!["ForwardRefStruct".to_string(), "late_field".to_string()] }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    },
  ];
  ...
  let violation =
    analysis.layout_violations.iter().find(|v| v.violating_type == "ForwardRefStruct").expect("Should find forward reference violation");
...
fn test_complex_transitive_dependency_chain() {
  let typedefs = vec![
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: Default::default(),
        fields: vec![
          StructField { name: "level1".to_string(), field_type: TypeKind::TypeRef(TypeRefType { name: "Level1".to_string(), comment: None }) },
          StructField { name: "target_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    },
    // Level 1 nesting
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        ...
        fields: vec![StructField {
          ...
          field_type: TypeKind::TypeRef(TypeRefType { name: "Level2".to_string(), comment: None }),
        }],
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        ...
        fields: vec![StructField {
          ...
          field_type: TypeKind::TypeRef(TypeRefType { name: "TransitiveArray".to_string(), comment: None }),
        }],
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        ...
        size: ExprKind::FieldRef(FieldRefExpr { path: vec!["RootContainer".to_string(), "target_field".to_string()] }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    },
  ];
  ...
  let violation =
    analysis.layout_violations.iter().find(|v| v.violating_type == "TransitiveArray").expect("Should find transitive dependency violation");
...
fn test_packed_vs_aligned_struct_analysis() {
  let typedefs = vec![
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: Default::default(),
        fields: vec![
          StructField { name: "byte_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) },
          StructField { name: "int_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    },
    // Packed struct
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: ContainerAttributes { packed: false, aligned: 16, comment: None },
        fields: vec![StructField { name: "byte_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) }],
      }),
    },
  ];
  ...
  resolver.resolve_all().expect("Should resolve all struct types");
...
fn test_constant_expression_analysis_integration() {
    ...
    TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        ...
        size: ExprKind::Mul(MulExpr {
          ...
          right: Box::new(ExprKind::Sizeof(SizeofExpr { type_name: "u32".to_string() })),
        }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        ...
        size: ExprKind::Add(AddExpr {
          ...
          right: Box::new(ExprKind::FieldRef(FieldRefExpr { path: vec!["dynamic_size".to_string()] })),
        }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    },
  ...
  if let ResolvedTypeKind::Array { size_constant_status, .. } = &constant_array.kind {
  ...
  if let ResolvedTypeKind::Array { size_constant_status, .. } = &dynamic_array.kind {
...
fn test_comprehensive_error_reporting() {
  let typedefs = vec![
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        ...
        fields: vec![
          StructField {
            name: "problematic_enum".to_string(),
            field_type: TypeKind::TypeRef(TypeRefType { name: "BadEnum".to_string(), comment: None }),
          },
          StructField {
            name: "problematic_array".to_string(),
            field_type: TypeKind::TypeRef(TypeRefType { name: "BadArray".to_string(), comment: None }),
          },
          StructField { name: "reference_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        container_attributes: Default::default(),
        tag_ref: ExprKind::FieldRef(FieldRefExpr { path: vec!["MultiViolationStruct".to_string(), "reference_field".to_string()] }),
        variants: vec![EnumVariant {
          name: "Variant1".to_string(),
          tag_value: 1,
          variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)),
    ...
    TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        container_attributes: Default::default(),
        size: ExprKind::FieldRef(FieldRefExpr { path: vec!["MultiViolationStruct".to_string(), "reference_field".to_string()] }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    },
  ];
  ...
  let enum_violations: Vec<_> = analysis.layout_violations.iter().filter(|v| v.violating_type == "BadEnum").collect();
  let array_violations: Vec<_> = analysis.layout_violations.iter().filter(|v| v.violating_type == "BadArray").collect();
  ...
  for violation in &analysis.layout_violations {
    ...
    assert!(!violation.violating_expression.is_empty(), "Should have violating expression");
    assert!(!violation.dependency_chain.is_empty(), "Should have dependency chain");
  }
}
...
fn test_real_world_scenario_token_account() {
  ...
  let typedefs = vec![TypeDef {
    ...
    kind: TypeKind::Struct(StructType {
      container_attributes: ContainerAttributes { packed: true, aligned: 1, comment: Some("Token account structure".to_string()) },
      fields: vec![
        StructField { name: "is_initialized".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) },
        StructField { name: "is_frozen".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) },
        StructField {
          name: "mint".to_string(),
          field_type: TypeKind::Array(ArrayType {
            container_attributes: Default::default(),
        ...
        StructField { name: "amount".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U64)) },
      ],
    }),
  }];
  ...
  assert!(analysis.layout_violations.is_empty());
  assert_eq!(analysis.topological_order, Some(vec!["TokenAccount".to_string()]));
  ...
  resolver.resolve_all().expect("Should resolve token account");
...
fn test_comprehensive_validation_integration() {
  ...
  let typedefs = vec![
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: Default::default(),
        fields: vec![
          StructField { name: "duplicate_field".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
          StructField {
            name: "duplicate_field".to_string(), // Duplicate field!
            field_type: TypeKind::TypeRef(TypeRefType { name: "ProblematicArray".to_string(), comment: None }),
          },
          StructField {
            name: "problematic_enum".to_string(),
            field_type: TypeKind::TypeRef(TypeRefType { name: "ProblematicEnum".to_string(), comment: None }),
    ...
    TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        ...
        size: ExprKind::FieldRef(FieldRefExpr { path: vec!["BadStruct".to_string(), "reference_field".to_string()] }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        ...
        tag_ref: ExprKind::FieldRef(FieldRefExpr { path: vec!["BadStruct".to_string(), "reference_field".to_string()] }),
        variants: vec![
          EnumVariant { name: "duplicate".to_string(), tag_value: 1, variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
          EnumVariant {
            name: "duplicate".to_string(), // Duplicate variant name!
            tag_value: 1,                  // Duplicate tag value!
            variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)),
          },
        ],
      }),
    },
    ...
    TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: Default::default(),
        fields: vec![
          StructField { name: "field1".to_string(), field_type: TypeKind::TypeRef(TypeRefType { name: "BaseType".to_string(), comment: None }) },
          StructField {
  ...
  assert!(!analysis.validation_errors.is_empty(), "Should have validation errors");
  assert!(!analysis.layout_violations.is_empty(), "Should have layout violations");

  // Check specific validation errors
  let validation_error_types: HashSet<String> = analysis.validation_errors.iter().map(|e| e.error_type.clone()).collect();
  ...
  let layout_violating_types: HashSet<String> = analysis.layout_violations.iter().map(|v| v.violating_type.clone()).collect();
