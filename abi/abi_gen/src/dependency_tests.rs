...
mod dependency_tests {
  ...
  fn create_field_ref_expr(path: Vec<&str>) -> ExprKind {
    ExprKind::FieldRef(FieldRefExpr { path: path.into_iter().map(|s| s.to_string()).collect() })
  }
  ...
  fn create_type_ref(name: &str) -> TypeKind {
    TypeKind::TypeRef(TypeRefType { name: name.to_string(), comment: None })
  }
  ...
  fn test_simple_type_dependency() {
    ...
    let typedefs = vec![
      TypeDef { name: "BaseType".to_string(), kind: create_u32_primitive() },
      TypeDef {
        name: "DerivedType".to_string(),
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![StructField { name: "base_field".to_string(), field_type: create_type_ref("BaseType") }],
        }),
      },
    ];
  ...
  fn test_circular_type_dependency() {
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![StructField { name: "field_b".to_string(), field_type: create_type_ref("TypeB") }],
        }),
      },
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![StructField { name: "field_a".to_string(), field_type: create_type_ref("TypeA") }],
        }),
      },
    ];
  ...
  fn test_valid_enum_with_constant_tag() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        ...
        variants: vec![EnumVariant { name: "Variant1".to_string(), tag_value: 1, variant_type: create_u32_primitive() }],
      }),
    }];
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "my_enum".to_string(), field_type: create_type_ref("MyEnum") },
            StructField { name: "other_field".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
      TypeDef {
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "dynamic_array".to_string(), field_type: create_type_ref("MyArray") },
            StructField { name: "size_field".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
      TypeDef {
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "early_field".to_string(), field_type: create_type_ref("ArrayWithForwardRef") },
            StructField { name: "middle_field".to_string(), field_type: create_u32_primitive() },
            StructField { name: "late_field".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
      TypeDef {
  ...
  fn test_complex_expression_dependencies() {
    ...
    let typedefs = vec![
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "field1".to_string(), field_type: create_u32_primitive() },
            StructField { name: "field2".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
    ];
    ...
    let enum_deps = analysis.graph.edges.iter().filter(|dep| dep.from == "ComplexEnum").collect::<Vec<_>>();
  ...
  fn test_sizeof_and_alignof_dependencies() {
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Array(ArrayType {
          container_attributes: Default::default(),
          size: ExprKind::Sizeof(SizeofExpr { type_name: "SomeType".to_string() }),
          element_type: Box::new(create_u8_primitive()),
        }),
      },
      TypeDef { name: "SomeType".to_string(), kind: create_u32_primitive() },
    ];
    ...
    let sizeof_deps = analysis.graph.edges.iter().filter(|dep| dep.from == "ArrayWithSizeof" && dep.to == "SomeType").collect::<Vec<_>>();
  ...
  fn test_union_dependencies() {
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Union(UnionType {
          container_attributes: Default::default(),
          variants: vec![
            UnionVariant { name: "variant1".to_string(), variant_type: create_type_ref("TypeA") },
            UnionVariant { name: "variant2".to_string(), variant_type: create_type_ref("TypeB") },
          ],
        }),
      },
      TypeDef { name: "TypeA".to_string(), kind: create_u32_primitive() },
      TypeDef { name: "TypeB".to_string(), kind: create_u8_primitive() },
    ];
    ...
    let union_deps = analysis.graph.edges.iter().filter(|dep| dep.from == "MyUnion").collect::<Vec<_>>();
  ...
  fn test_packed_struct_analysis() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: ContainerAttributes { packed: true, aligned: 0, comment: None },
        fields: vec![
          StructField { name: "field1".to_string(), field_type: create_u8_primitive() },
          StructField { name: "field2".to_string(), field_type: create_u32_primitive() },
        ],
      }),
    }];
  ...
  fn test_aligned_struct_analysis() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: ContainerAttributes { packed: false, aligned: 16, comment: Some("16-byte aligned".to_string()) },
        fields: vec![StructField { name: "field1".to_string(), field_type: create_u32_primitive() }],
      }),
    }];
  ...
  fn test_deeply_nested_type_cycle() {
    ...
    let typedefs = vec![
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![StructField { name: "field_c".to_string(), field_type: create_type_ref("TypeC") }],
        }),
      },
      TypeDef {
  ...
  fn test_transitive_layout_dependency_violation() {
    ...
    let typedefs = vec![
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "type_a".to_string(), field_type: create_type_ref("TypeA") },
            StructField { name: "type_b".to_string(), field_type: create_type_ref("TypeB") },
            StructField { name: "reference_field".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![StructField { name: "dynamic_array".to_string(), field_type: create_type_ref("DynamicArray") }],
        }),
      },
      ...
      TypeDef { name: "TypeB".to_string(), kind: create_u32_primitive() },
    ];
    ...
    let violations: Vec<_> = analysis.layout_violations.iter().filter(|v| v.violating_type == "DynamicArray").collect();
  ...
  fn test_multiple_field_references_in_expression() {
    ...
    let typedefs = vec![
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "size1".to_string(), field_type: create_u32_primitive() },
            StructField { name: "size2".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
    ];
    ...
    let array_deps = analysis.graph.edges.iter().filter(|dep| dep.from == "ComplexArray").collect::<Vec<_>>();
  ...
  fn test_array_with_non_constant_element_type() {
    ...
    assert!(!analysis.layout_violations.is_empty());
    let violation = analysis.layout_violations.iter().find(|v| v.violating_type == "BadArray").expect("Should find violation for BadArray");

    assert!(violation.reason.contains("element type with non-constant size"));
    assert!(violation.violating_expression.contains("array element type"));
  }
  ...
  fn test_array_with_deeply_nested_non_constant_element_type() {
    ...
    let typedefs = vec![
      ...
      TypeDef {
        ...
        kind: TypeKind::Enum(EnumType {
          ...
          variants: vec![
            EnumVariant { name: "Variant1".to_string(), tag_value: 1, variant_type: create_u32_primitive() },
            EnumVariant {
    ...
    assert!(!analysis.layout_violations.is_empty());
    let violation = analysis.layout_violations.iter().find(|v| v.violating_type == "DeepArray").expect("Should find violation for DeepArray");
  ...
  fn test_shift_operations_in_expressions() {
    ...
    let typedefs = vec![
        ...
        kind: TypeKind::Array(ArrayType {
          ...
          size: ExprKind::RightShift(RightShiftExpr {
            left: Box::new(ExprKind::LeftShift(LeftShiftExpr {
              left: Box::new(create_field_ref_expr(vec!["ConfigStruct", "base_size"])),
              right: Box::new(create_field_ref_expr(vec!["ConfigStruct", "shift_amount"])),
            })),
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "base_size".to_string(), field_type: create_u32_primitive() },
            StructField { name: "shift_amount".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
    ];
    ...
    let array_deps = analysis.graph.edges.iter().filter(|dep| dep.from == "ShiftArray").collect::<Vec<_>>();

    assert!(array_deps.len() >= 2);

    // Check that both base_size and shift_amount are referenced
    let dep_targets: Vec<&String> = array_deps.iter().map(|dep| &dep.to).collect();
    assert!(dep_targets.iter().any(|target| target.contains("base_size")));
    assert!(dep_targets.iter().any(|target| target.contains("shift_amount")));
  }
  ...
  fn test_single_primitive_typedef() {
    ...
    let typedefs = vec![TypeDef { name: "MyU32".to_string(), kind: create_u32_primitive() }];
  ...
  fn test_constant_expression_analysis() {
    ...
    let sizeof_expr = ExprKind::Sizeof(SizeofExpr { type_name: "SomeType".to_string() });
    assert!(sizeof_expr.is_constant());

    let mixed_expr = ExprKind::Add(AddExpr { left: Box::new(literal_expr), right: Box::new(field_ref_expr) });
    assert!(!mixed_expr.is_constant());

    let const_expr = ExprKind::Mul(MulExpr { left: Box::new(create_literal_expr(10)), right: Box::new(create_literal_expr(20)) });
    assert!(const_expr.is_constant());

    // Test shift operations
    let left_shift_expr = ExprKind::LeftShift(LeftShiftExpr { left: Box::new(create_literal_expr(4)), right: Box::new(create_literal_expr(2)) });
    assert!(left_shift_expr.is_constant());

    let right_shift_expr = ExprKind::RightShift(RightShiftExpr { left: Box::new(create_literal_expr(16)), right: Box::new(create_literal_expr(2)) });
    assert!(right_shift_expr.is_constant());

    let mixed_shift_expr =
      ExprKind::LeftShift(LeftShiftExpr { left: Box::new(create_literal_expr(8)), right: Box::new(create_field_ref_expr(vec!["shift_amount"])) });
    ...
    let popcount_non_const_expr = ExprKind::Popcount(PopcountExpr { operand: Box::new(create_field_ref_expr(vec!["some_field"])) });
  ...
  fn test_duplicate_type_names() {
    ...
    let typedefs = vec![
      TypeDef { name: "DuplicateName".to_string(), kind: create_u32_primitive() },
      TypeDef {
    ...
    let duplicate_error =
      analysis.validation_errors.iter().find(|e| e.error_type == "DuplicateTypeName").expect("Should find duplicate type name error");
  ...
  fn test_duplicate_struct_field_names() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: Default::default(),
        fields: vec![
          StructField { name: "duplicate_field".to_string(), field_type: create_u32_primitive() },
          StructField {
            name: "duplicate_field".to_string(), // Duplicate!
            field_type: create_u8_primitive(),
          },
          StructField { name: "unique_field".to_string(), field_type: create_u32_primitive() },
        ],
      }),
    }];
    ...
    assert!(!analysis.validation_errors.is_empty());
    let duplicate_error =
      analysis.validation_errors.iter().find(|e| e.error_type == "DuplicateFieldName").expect("Should find duplicate field name error");
  ...
  fn test_duplicate_union_variant_names() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Union(UnionType {
        container_attributes: Default::default(),
        variants: vec![
          UnionVariant { name: "duplicate_variant".to_string(), variant_type: create_u32_primitive() },
          UnionVariant {
    ...
    assert!(!analysis.validation_errors.is_empty());
    let duplicate_error =
      analysis.validation_errors.iter().find(|e| e.error_type == "DuplicateVariantName").expect("Should find duplicate variant name error");
  ...
  fn test_duplicate_enum_variant_names() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        ...
        variants: vec![
          EnumVariant { name: "duplicate_variant".to_string(), tag_value: 1, variant_type: create_u32_primitive() },
          EnumVariant {
  ...
  fn test_duplicate_enum_tag_values() {
    ...
    assert!(!analysis.validation_errors.is_empty());
    let duplicate_error =
      analysis.validation_errors.iter().find(|e| e.error_type == "DuplicateTagValue").expect("Should find duplicate tag value error");
  ...
  fn test_multiple_validation_errors() {
    ...
    let typedefs = vec![
      ...
      TypeDef { name: "DuplicateType".to_string(), kind: create_u32_primitive() },
      TypeDef { name: "DuplicateType".to_string(), kind: create_u8_primitive() },
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "bad_field".to_string(), field_type: create_u32_primitive() },
            StructField { name: "bad_field".to_string(), field_type: create_u8_primitive() },
          ],
        }),
      },
      ...
      TypeDef {
        ...
        kind: TypeKind::Enum(EnumType {
          ...
          tag_ref: create_literal_expr(0),
          variants: vec![
            EnumVariant { name: "bad_variant".to_string(), tag_value: 5, variant_type: create_u32_primitive() },
            EnumVariant { name: "bad_variant".to_string(), tag_value: 5, variant_type: create_u8_primitive() },
          ],
        }),
      },
    ];
    ...
    let error_types: HashSet<String> = analysis.validation_errors.iter().map(|e| e.error_type.clone()).collect();
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          ...
          fields: vec![
            StructField { name: "field1".to_string(), field_type: create_u32_primitive() },
            StructField { name: "field2".to_string(), field_type: create_u8_primitive() },
          ],
        }),
      },
      TypeDef {
        ...
        kind: TypeKind::Enum(EnumType {
          ...
          variants: vec![
            EnumVariant { name: "variant1".to_string(), tag_value: 1, variant_type: create_u32_primitive() },
            EnumVariant { name: "variant2".to_string(), tag_value: 2, variant_type: create_u8_primitive() },
          ],
        }),
      },
      TypeDef {
        ...
        kind: TypeKind::Union(UnionType {
          container_attributes: Default::default(),
          variants: vec![
            UnionVariant { name: "variant1".to_string(), variant_type: create_u32_primitive() },
            UnionVariant { name: "variant2".to_string(), variant_type: create_u8_primitive() },
          ],
        }),
      },
    ];
  ...
  fn test_layout_dependency_chain_detection() {
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "intermediate".to_string(), field_type: create_type_ref("IntermediateStruct") },
            StructField { name: "target_field".to_string(), field_type: create_u32_primitive() },
          ],
        }),
      },
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![StructField { name: "problematic_array".to_string(), field_type: create_type_ref("ProblematicArray") }],
        }),
      },
      TypeDef {
    ...
    let violation =
      analysis.layout_violations.iter().find(|v| v.violating_type == "ProblematicArray").expect("Should find violation for ProblematicArray");
    ...
    let typedefs = vec![
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "my_enum".to_string(), field_type: create_type_ref("ConstantSizeEnum") },
            StructField { name: "tag_field".to_string(), field_type: create_u32_primitive() },
            StructField { name: "other_data".to_string(), field_type: create_u64_primitive() },
          ],
        }),
      },
      TypeDef {
  ...
  fn create_size_discriminated_union(_name: &str, variants: Vec<(&str, u64, TypeKind)>) -> TypeKind {
    TypeKind::SizeDiscriminatedUnion(SizeDiscriminatedUnionType {
      container_attributes: Default::default(),
      variants: variants
        .into_iter()
        .map(|(variant_name, size, variant_type)| SizeDiscriminatedVariant { name: variant_name.to_string(), expected_size: size, variant_type })
        .collect(),
    })
  }
  ...
  fn test_valid_size_discriminated_union() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: create_size_discriminated_union(
        "TokenAccountUnion",
        vec![("token_account", 165, create_u32_primitive()), ("token_mint", 82, create_u64_primitive())],
      ),
    }];
  ...
  fn test_size_discriminated_union_insufficient_variants() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: create_size_discriminated_union("SingleVariantUnion", vec![("only_variant", 100, create_u32_primitive())]),
    }];
  ...
  fn test_size_discriminated_union_with_other_variable_factor() {
    ...
    let typedefs = vec![
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
          fields: vec![
            StructField { name: "account_data".to_string(), field_type: create_type_ref("TokenAccountUnion") },
            StructField {
              name: "dynamic_array".to_string(),
              field_type: TypeKind::Array(ArrayType {
                container_attributes: Default::default(),
    ...
    assert!(!analysis.layout_violations.is_empty());
    let violation =
      analysis.layout_violations.iter().find(|v| v.violating_type == "InvalidContainer").expect("Should find violation for InvalidContainer");
  ...
  fn test_size_discriminated_union_in_array() {
    ...
    assert!(!analysis.layout_violations.is_empty());
    let violation = analysis.layout_violations.iter().find(|v| v.violating_type == "InvalidArray").expect("Should find violation for InvalidArray");
    assert!(violation.reason.contains("Arrays cannot have elements with variable sizes"));
  }
  ...
  fn test_size_discriminated_union_in_regular_union() {
    ...
    assert!(!analysis.layout_violations.is_empty());
    let violation =
      analysis.layout_violations.iter().find(|v| v.violating_type == "InvalidRegularUnion").expect("Should find violation for InvalidRegularUnion");
    assert!(violation.reason.contains("unions/enums cannot contain size-discriminated unions"));
  }
  ...
  fn test_size_discriminated_union_via_typeref_propagation() {
    ...
    let typedefs = vec![
      ...
      TypeDef { name: "WrapperType".to_string(), kind: create_type_ref("TokenAccountUnion") },
      TypeDef {
        name: "InvalidContainer".to_string(),
        kind: TypeKind::Struct(StructType {
          container_attributes: Default::default(),
  ...
  fn test_size_discriminated_union_duplicate_variant_names() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::SizeDiscriminatedUnion(SizeDiscriminatedUnionType {
        container_attributes: Default::default(),
        variants: vec![
          SizeDiscriminatedVariant { name: "duplicate_name".to_string(), expected_size: 100, variant_type: create_u32_primitive() },
    ...
    assert!(!analysis.validation_errors.is_empty());
    let error = analysis.validation_errors.iter().find(|e| e.error_type == "DuplicateVariantName").expect("Should find duplicate variant name error");
...
mod resolved_tests {
  ...
  fn test_constant_status_analysis() {
    ...
    let field_expr = ExprKind::FieldRef(FieldRefExpr { path: vec!["field".to_string()] });
    let status = resolver.analyze_expression_constantness(&field_expr, None).unwrap();
    assert!(matches!(status, ConstantStatus::NonConstant(_)));

    // Test complex expression with field reference
    let complex_expr = ExprKind::Add(AddExpr { left: Box::new(const_expr), right: Box::new(field_expr) });
    let status = resolver.analyze_expression_constantness(&complex_expr, None).unwrap();
    assert!(matches!(status, ConstantStatus::NonConstant(_)));
  }
  ...
  fn test_primitive_type_resolution() {
    ...
    let typedef = TypeDef { name: "MyU32".to_string(), kind: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) };
  ...
  fn test_struct_type_resolution() {
    ...
    let typedefs = vec![TypeDef {
      ...
      kind: TypeKind::Struct(StructType {
        container_attributes: Default::default(),
        fields: vec![
          StructField { name: "field1".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) },
          StructField { name: "field2".to_string(), field_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    }];
  ...
  fn test_array_with_constant_size() {
    ...
    if let ResolvedTypeKind::Array { size_constant_status, .. } = &resolved.kind {
  ...
  fn test_array_with_field_reference() {
    ...
    let typedef = TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        container_attributes: Default::default(),
        size: ExprKind::FieldRef(FieldRefExpr { path: vec!["some_field".to_string()] }),
        element_type: Box::new(TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8))),
      }),
    };
    ...
    if let ResolvedTypeKind::Array { size_constant_status, .. } = &resolved.kind {
      assert!(matches!(size_constant_status, ConstantStatus::NonConstant(_)));
    } else {
      panic!("Expected array type");
    }
  }
  ...
  fn test_union_type_resolution() {
    ...
    let typedef = TypeDef {
      ...
      kind: TypeKind::Union(UnionType {
        container_attributes: Default::default(),
        variants: vec![
          UnionVariant { name: "variant1".to_string(), variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) },
          UnionVariant { name: "variant2".to_string(), variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
        ],
      }),
    };
  ...
  fn test_enum_type_resolution() {
    ...
    let typedef = TypeDef {
      ...
      kind: TypeKind::Enum(EnumType {
        ...
        variants: vec![
          EnumVariant { name: "Variant1".to_string(), tag_value: 1, variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U32)) },
          EnumVariant { name: "Variant2".to_string(), tag_value: 2, variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U8)) },
        ],
      }),
    };
    ...
    assert_eq!(resolved.size, Size::Const(4)); // Maximum variant size (u32 = 4 bytes)
    assert_eq!(resolved.alignment, 4); // Alignment of largest variant

    if let ResolvedTypeKind::Enum { tag_constant_status, variants, .. } = &resolved.kind {
  ...
  fn test_circular_type_reference_detection() {
      ...
      TypeDef {
        ...
        kind: TypeKind::Struct(StructType {
          ...
          fields: vec![StructField {
            ...
            field_type: TypeKind::TypeRef(TypeRefType { name: "TypeB".to_string(), comment: None }),
          }],
        }),
      },
      TypeDef { name: "TypeB".to_string(), kind: TypeKind::TypeRef(TypeRefType { name: "TypeA".to_string(), comment: None }) },
    ];
    ...
    assert!(matches!(result.unwrap_err(), ResolutionError::CircularDependency(_)));
  }
  ...
  fn test_field_reference_collection() {
    ...
    let simple_ref = ExprKind::FieldRef(FieldRefExpr { path: vec!["field".to_string()] });
    let status = resolver.analyze_expression_constantness(&simple_ref, None).unwrap();
    ...
    let complex_expr = ExprKind::Add(AddExpr {
      left: Box::new(ExprKind::FieldRef(FieldRefExpr { path: vec!["field1".to_string()] })),
      right: Box::new(ExprKind::Mul(MulExpr {
        left: Box::new(ExprKind::FieldRef(FieldRefExpr { path: vec!["field2".to_string()] })),
  ...
  fn test_non_constant_dependency_tracking() {
    ...
    let typedef = TypeDef {
      ...
      kind: TypeKind::Array(ArrayType {
        container_attributes: Default::default(),
        size: ExprKind::Add(AddExpr {
          left: Box::new(ExprKind::FieldRef(FieldRefExpr { path: vec!["size_field".to_string()] })),
    ...
    let resolved = resolver.get_type_info("DependentArray").expect("Type should be resolved");
  ...
  fn test_size_discriminated_union_type_resolution() {
      ...
      kind: TypeKind::SizeDiscriminatedUnion(SizeDiscriminatedUnionType {
        ...
        variants: vec![
          ...
          SizeDiscriminatedVariant {
            ...
            expected_size: 82,
            variant_type: TypeKind::Primitive(PrimitiveType::Integral(IntegralType::U64)),
          },
        ],
      }),
    };
    ...
    if let ResolvedTypeKind::SizeDiscriminatedUnion { variants } = &resolved.kind {
      ...
      assert_eq!(variants[0].expected_size, 165);
      assert_eq!(variants[1].name, "token_mint");
      assert_eq!(variants[1].expected_size, 82);
    } else {
